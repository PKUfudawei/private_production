...
# Run the cmsRun
cmsRun -e -j $REPORT_NAME NanoAODv9_1_cfg.py || exit $? ;

# Parse values from NanoAODv9_report.xml report
...
echo "Validation report of NanoAODv9 sequence 1/1"
...
# End of NanoAODv9_test.sh file
EndOfTestFile

# Make file executable
sed -i "s/\$(echo \$EVENTS_VALUE)/$EVENTS/g" NanoAODv9_test.sh
chmod +x NanoAODv9_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/NanoAODv9_test.sh)
